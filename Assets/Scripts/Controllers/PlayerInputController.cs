    ...
    public void Update()
    {
        ...
        switch (inputState)
        {
            case PlayerInputState.Game:
                ...
                playerButtonInput[(int)ButtonInput.QuickHeal] = mGamepadInput.ButtonXPressed();
                playerButtonInput[(int)ButtonInput.OpenCloseInventory] = mGamepadInput.ButtonYPressed();
