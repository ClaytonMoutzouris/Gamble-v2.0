...
public class Character : PhysicsObject
{
    ...
    public override void CustomUpdate()
    {
        ...
        switch (mCurrentState)
        {
            ...
            case CharacterState.GrabLedge:
                ...
                bool ledgeOnLeft = mLedgeTile.x * MapManager.cTileSize < mPosition.x;
            ...
            case CharacterState.Climbing:
                ...
                mPosition.x = tx * MapManager.cTileSize;
    ...
    public ItemObject CheckForItems()
    {
        ...
        for (int i = 0; i < mAllCollidingObjects.Count; ++i)
        {
            ...
            if(mAllCollidingObjects[i].other.mCollisionType == CollisionType.Item)
            {
    ...
    public Chest CheckForChest()
    {
        ...
        {
            //Debug.Log(mAllCollidingObjects[i].other.name);
            if (mAllCollidingObjects[i].other.mCollisionType == CollisionType.Chest)
            {
