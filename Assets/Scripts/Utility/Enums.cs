...
public enum EffectType { ExtraJump, Hover, Lifesteal, DamageReflect, PoisonAttack, StunAttack, SuperSpeed, SpikeProtection, CrushProtection, Flamewalker, Heavy, ExtraDamage, Knockback, CompanionDrone, ChestFinder, HealthFromFood, ReusableMedkits };
