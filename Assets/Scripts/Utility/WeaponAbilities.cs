...
public static class WeaponAbilities
{
    ...
    public static void Split(Projectile original, IHurtable hit)
    {
        ...
        RangedAttack rattack = new RangedAttack(original.Owner, 0.5f, 50, 0, 1, 0, original.prototype, Vector2.zero, new List<WeaponAbility>());
        Projectile shot = new Projectile(original.prototype, rattack, original.direction + new Vector2(-0.5f, 0.5f));
        shot.mHitbox.mDealtWith.Add(hit);
        shot.Spawn(original.Position);

        RangedAttack rattack2 = new RangedAttack(original.Owner, 0.5f, 50, 0, 1, 0, original.prototype, Vector2.zero, new List<WeaponAbility>());
        Projectile shot2 = new Projectile(original.prototype, rattack2, original.direction + new Vector2(0.5f, 0.5f));
        shot2.mHitbox.mDealtWith.Add(hit);
