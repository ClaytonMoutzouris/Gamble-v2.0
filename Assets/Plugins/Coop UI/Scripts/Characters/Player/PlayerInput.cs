...
namespace LocalCoop {
    ...
    public class PlayerInput : MonoBehaviour {
        ...
        public bool LeftStickTapDown()
        {
            if (Use_X_Input)
            {
                return (prevState.ThumbSticks.Left.Y >= 0 &&
              state.ThumbSticks.Left.Y < 0) ? true : false;
            }

            return false;
        }

        public bool LeftStickTapUp()
        {
            if (Use_X_Input)
            {
                return (prevState.ThumbSticks.Left.Y <= 0 &&
